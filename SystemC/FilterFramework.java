...
public class FilterFramework extends Thread
{
	...
	public Boolean isAvailableA = true;
	public Boolean isAvailableB = true;
	...
	****************************************************************************/
	...
	byte ReadFilterInputPortA() throws EndOfStreamException
	{
		byte datum = 0;
		...
		try
		{
			...
			{
				if (EndOfInputStreamA())
				{
					isAvailableA = false;
					throw new EndOfStreamException("End of input stream A reached");
	...
	byte ReadFilterInputPortB() throws EndOfStreamException
	{
		...
		try
		{
			while (InputReadPortB.available()==0 )
			{
				...
				{
					isAvailableB = false;
					throw new EndOfStreamException("End of input stream B reached");
	...
	****************************************************************************/
	...
	private boolean EndOfInputStreamA()
	{
